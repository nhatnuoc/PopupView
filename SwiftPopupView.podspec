...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftPopupView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Nguyễn Thanh Bình/SwiftPopupView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nguyễn Thanh Bình' => 'binhnt77@fpt.com' }
  s.source           = { :git => 'https://github.com/Nguyễn Thanh Bình/SwiftPopupView.git', :tag => s.version.to_s }
